...
public class BufferedInputStream extends FileInputStream {
  ...
  public int read() throws IOException {
    ...
    // 예) 0x7f(01001111; 10진수로 127) 값을 리턴한다면 4바이트 int 값 0x0000007f가 리턴 된다.
    // 문제는 첫 비트가 1로 시작하는 바이트 값을 int로 리턴하는 경우이다.
    // JVM은 첫 비트가 1일 경우 음수 간주하고 byte 값을 int로 바꿀때 앞의 3바이트를 모두 음수를 의미하는 1로 설정한다.
    // 예) 0x80(10000000, 10진수로 128) 값을 리턴 한다면 
