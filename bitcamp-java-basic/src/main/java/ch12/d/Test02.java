...
public class Test02 {
  ...
  public static void main(String[] args) {
    ...
    p2.setName("이철희");
    p2.setAge(300); // 캡슐화를 무너뜨를 수 있는  유효하지 않은 값은 무시된다.
    p2.setWeight(-50); // 캡슐화를 무너뜨를 수 있는  유효하지 않은 값은 무시된다.
    p2.setHeight(400); // 캡슐화를 무너뜨를 수 있는  유효하지 않은 값은 무시된다.
    p2.setGender(3); // 캡슐화를 무너뜨를 수 있는  유효하지 않은 값은 무시된다.
