...
public class Queue<E> extends LinkedList<E> implements Cloneable{
  ...
  //    중첩 클래스 중에서 static이 안 붙은 중첩 클래스르 "non-static nested class"라 부른다.
  //    non-static nested class를 "innter class"라 부른다.
  ...
  private class QueueIterator implements Iterator<E>{
    ...
    public boolean hasNext() {
      ...
      // 만약 사용하려면 필드나 메서드가 중첩 클래스에 있는 필드나 메서드가 아라면
